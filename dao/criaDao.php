<?php
    ...
    $variaveis=array('id','nome','email','tel','endereco','batizado','dt_batismo','dt_nascimento','criado','modificado','excluido');
    ...
    $texto .= '   '."private ".'$db'." = null;\r\n".
              ...
              '      $this'."->db = null;\r\n".
              '   '."}\r\n"; 
    $texto .= '   public function encontre(ModelSearchCriteria $search = null,$tabela){
            set_time_limit(3600);
    ...
    $texto .= '   private function getEncontreSql(ModelSearchCriteria $search = null,$tabela=null) {               
          if ($search !== null) {
             if($search->getmes()){
